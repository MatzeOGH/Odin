...
//
// It spawns N worker threads that hammer the livepatched `work` procedure in a
...
// Under -livepatch every procedure is livepatchable automatically (no tag needed).
work :: proc(s: ^State) {
	s.n += 1
}
