...
#
# Builds the test .exe (-hot-reload, VER=1), simulates an edit (VER 1->2 and
...
$env:ODIN_ROOT = $repo   # use THIS repo's core (with the hot-reload changes), not a global ODIN_ROOT
