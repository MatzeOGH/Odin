...
#
# Do NOT rebuild the exe (that restarts the process). `-hot-reload-patch` builds only the
...
Write-Host '==> recompiling game.odin -> hot_objs\ (odin build . -hot-reload-patch)'
